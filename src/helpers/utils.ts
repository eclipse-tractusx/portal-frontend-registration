...
export const PATTERNS = {
  ...
  en: {
    COMMERCIAL_REG_NUMBER: /^[a-zA-Z0-9-]{6,21}$/,
    VAT_ID: /^[a-zA-Z0-9-]{5,6}$/,
    LEI_CODE: /^[a-zA-Z0-9]{20}$/,
    VIES: /.*/,
    EORI: /.*/
  },
  de: {
    COMMERCIAL_REG_NUMBER: /^[a-zA-Z0-9-\s]{9}$/,
    VAT_ID: /^DE[0-9]{9}$/,
    LEI_CODE: /^[a-zA-Z0-9]{20}$/,
    VIES: /.*/,
    EORI: /.*/
  ...
  fr: {
    COMMERCIAL_REG_NUMBER: /^[a-zA-Z0-9\s]{14,17}$/,
    VAT_ID: /^[a-zA-Z0-9-\s]{8,15}$/,
    LEI_CODE: /^[a-zA-Z0-9]{20}$/,
    VIES: /.*/,
    EORI: /.*/
  },
