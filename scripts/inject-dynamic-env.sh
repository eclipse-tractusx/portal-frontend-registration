...
custom_env_vars_anchor='{PORTAL_ASSETS_URL:"https://portal.dev.demo.catena-x.net/assets",PORTAL_BACKEND_URL:"https://portal-backend.dev.demo.catena-x.net",CENTRALIDP_URL:"https://centralidp.dev.demo.catena-x.net/auth"}'
